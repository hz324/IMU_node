 ...
 *	\date		03/11/08
 *
 *	\brief		Version header file for our sbgCom library.<br>
 ...
 *	When we receive an invalid frame in sbgProtocolReceiveTimeOut, we keep trying to get an answer until we reach our time out.
 *	</td></tr>
 *
 ...
 *	</table>
 */
#define SBG_COM_VERSION		"1.5.0.0"
#define SBG_COM_VERSION_U	SBG_VERSION(1,5,0,0)
#define SBG_COM_VERSION_R	"1, 5, 0, 0\0"
#define SBG_COM_VERSION_W	1,5,0,0
