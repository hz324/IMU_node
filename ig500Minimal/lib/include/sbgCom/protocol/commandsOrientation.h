 ...
 *	\date		02/04/07
 *
 *	\brief		Commands used to align our device frame.<br>
...
/*!
 *	Defines the pre or post rotation to applied to our device.<br>
 ...
 */
SbgErrorCode sbgSetManualOrientationOffset(SbgProtocolHandle handle, bool permanent, SbgOffsetType offsetType, const float rotationMatrix[9]);
 ...
 *	\return								SBG_NO_ERROR if no error.
 */
SbgErrorCode sbgSetAutoOrientationOffset(SbgProtocolHandle handle, bool permanent, SbgOffsetType offsetType);

/*!
 *	Returns the pre or post rotation applied to our device.<br>
 *	\param[in]	handle					Valid sbgCom library handle.
