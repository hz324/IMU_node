...
#define SBG_NMEA_OPT_ALT_ABOVE_MSL				0x0001		/*!< Altitude is referenced to Mean Sea Level */
#define SBG_NMEA_OPT_ALT_ABOVE_ELLIPSOID		0x0000		/*!< Altitude is referenced to ellipsoid */
 ...
 *									- SBG_NMEA_OPT_ALT_ABOVE_MSL
 *									- SBG_NMEA_OPT_ALT_ABOVE_ELLIPSOID
 *	\param[in]	stdHeadingAcuracy	True heading standard accuracy. Expressed in ° with 1 LSB = 10e-5 °
 *	\return							SBG_NO_ERROR if no error.
 */
SbgErrorCode sbgExtNmeaSetOptions(SbgProtocolHandle handle, bool permanent, uint16 options, uint32 stdHeadingAcuracy);
 ...
 *	\return							SBG_NO_ERROR if no error.
 */
SbgErrorCode sbgExtNmeaSetYawOffset(SbgProtocolHandle handle, bool permanent, float offset);
 ...
 *	\return							SBG_NO_ERROR if no error.
 */
SbgErrorCode sbgExtNmeaSetMatrixOffset(SbgProtocolHandle handle, bool permanent, const float matrixOffset[9]);
